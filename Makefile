...
all: my-pass.o
	/home/benwu25/Documents/mirror/llvm-project/debug-install/bin/clang++ -g -Wall -Wextra -Wno-unused-variable -Wno-unused-parameter -Wno-unused-but-set-variable -Werror -fPIC -shared -I/home/benwu25/Documents/mirror/llvm-project/debug-install/include/ -L/home/benwu25/Documents/mirror/llvm-project/debug-install/lib -o libClangPlugin.so clang-plugin.cpp my-pass.o
